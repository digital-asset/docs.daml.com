...
The previously described strongly typed instruments (e.g. Bonds and Swaps) have the advantage that
the instrument terms are reflected as template variables. Also, the name of the template directly
indicates what type of instrument it is.
