...
.. note::
   For more information on Helm, please refer to the `Helm Quickstart Guide <https://helm.sh/docs/intro/quickstart/>`_.
...
.. code-block:: bash
   ...
   digital-asset/canton-domain      0.3.0           2.7.0           A Helm chart for Canton Domains            
   digital-asset/canton-participant 0.3.0           2.7.0           A Helm chart for Canton Participants       
   digital-asset/daml-http-json     0.3.0           2.7.0           A Helm chart for Daml HTTP JSON API service
   digital-asset/daml-trigger       0.3.0           2.7.0           A Helm chart for Daml Trigger service
