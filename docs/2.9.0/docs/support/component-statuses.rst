...
.. list-table::
   ...
   * - Canton Application and Console
     - Stable
     -
   * - Canton Administrative APIs for participant nodes and sync domains
     - Stable
     -
   * - Canton Protocol
     - Stable
   ...
   * - Sequencer for Hyperledger Besu
     - Beta
     -
   * - Support for connecting a single participant to multiple sync domains
     - Alpha
     -
   * - **JSON API**
     - 
...
.. list-table::
   ...
   * - Daml Linter (``daml damlc lint``)
     - Stable
     -
   * - Daml REPL (Deprecated) (``daml damlc repl``)
