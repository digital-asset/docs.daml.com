...
With the bellow example as reference, instead of sending a batch with 20 exercise commands `Foo`,
...
As a rule, the number of views should depend on the number of informee participants
