...
As of `v2.5.0 <https://blog.digitalasset.com/developers/release-notes/2.5.0>`__, the sync domain manager uses PostgreSQL in an HA configuration for HA support.
