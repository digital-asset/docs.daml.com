...
In a distributed application, where different systems such as ledger clients, Triggers, Nanobots, Ingestion Applications, and the like submit transactions, it may not be easy to understand where the contention is coming from. Here is a recipe that can be used on the Canton level:
