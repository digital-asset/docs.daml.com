...
This guide has been tested with the SDK version 2.4.2. Set the environment variable ``DAML_SDK_VERSION`` to ``2.4.2`` so that
subsequent ``daml`` commands use this version.

.. code-block:: bash

    export DAML_SDK_VERSION=2.4.2
...
.. code-block:: bash
    ...
    DAML_SDK_VERSION=2.4.2 daml json-api \
