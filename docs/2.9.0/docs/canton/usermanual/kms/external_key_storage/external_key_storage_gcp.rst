...
store private keys in an external GCP KMS. The same configuration is applicable for all other node entities, including the synchronizer manager,
...
Below are links to guides on how to manually initialize participant and synchronizer nodes.
