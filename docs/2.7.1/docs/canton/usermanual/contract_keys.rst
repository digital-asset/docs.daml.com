...
.. note::
    ...
    Non-Unique contract keys is preview only and may not function as documented. Multiple keys will override each other.
...
Thus, two ``Initialization`` contracts may be created.
